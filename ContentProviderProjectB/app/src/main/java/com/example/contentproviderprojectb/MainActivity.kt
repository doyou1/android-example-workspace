...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cursor = contentResolver.query(Uri.parse("content://$authority/getdataall"), null, null, null, null)
            ?: return
        ...
        while (cursor.moveToNext()) {
            str += "${cursor.getInt(0)}, ${cursor.getString(1)}, ${cursor.getString(2)}, ${cursor.getInt(3)}\n"
        }
